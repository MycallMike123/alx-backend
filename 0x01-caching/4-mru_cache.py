...
"""
MRU cache module that inherits from BaseCaching and is a caching
system Must use self.cache_data - dictionary from the parent class
BaseCaching MRU algorithm must be used to manage the cache
"""
...
class MRUCache(BaseCaching):
    ...
    def put(self, key, item):
        ...
        than BaseCaching.MAX_ITEMS:
            1) discard the most recently used item in self.cache_keys
            2) discard the most recently used item in self.cache_data
        """
        ...
        if len(self.cache_data) >= BaseCaching.MAX_ITEMS:
            ...
            # print the discarded key for debugging
